...
class RunType:
    ...
    :ivar experiment_ref: The EXPERIMENT_REF identifies the parent
        experiment.                        Experiment describes nucleic
        acid prepararation from biological sample,
        molecular strategies and selections used in preparation of
